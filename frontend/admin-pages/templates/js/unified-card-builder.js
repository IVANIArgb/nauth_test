...
function createCourseCardFromModule(course, options = {}) {
    ...
    card.addEventListener('dblclick', (e) => {
        ...
        if (isAccessible) {
            ...
            (typeof customAlert === 'function' ? customAlert : alert)(course.locked_reason || 'Материал недоступен. Пройдите предыдущие курсы в последовательности.', 'Материал недоступен');
        }
    });
